...
if (manifest.id !== "heading-numerals" || manifest.name !== "Heading Numerals") {
...
process.stdout.write(`Release contract passed for Heading Numerals ${version}; bundle=${Buffer.byteLength(bundle)} bytes.\n`);
